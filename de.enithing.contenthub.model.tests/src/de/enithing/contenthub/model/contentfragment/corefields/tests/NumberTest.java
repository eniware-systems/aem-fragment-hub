...
public class NumberTest extends ContentFragmentFieldTypeTest {
	 ...
	 */
	@Override
	protected de.enithing.contenthub.model.contentfragment.corefields.Number getFixture() {
		return (de.enithing.contenthub.model.contentfragment.corefields.Number)fixture;
	}
