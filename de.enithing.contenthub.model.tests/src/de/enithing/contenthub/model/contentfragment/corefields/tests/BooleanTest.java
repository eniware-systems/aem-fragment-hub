 ...
 * @generated
 */
public class BooleanTest extends ContentFragmentFieldTypeTest {
	 ...
	 */
	@Override
	protected de.enithing.contenthub.model.contentfragment.corefields.Boolean getFixture() {
		return (de.enithing.contenthub.model.contentfragment.corefields.Boolean)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(CorefieldsFactory.eINSTANCE.createBoolean());
	}
