 ...
 * </p>
 * <ul>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.SingleLineTextImpl#isAllowMultiple <em>Allow Multiple</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.SingleLineTextImpl#getMaxItems <em>Max Items</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.SingleLineTextImpl#getPlaceholder <em>Placeholder</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.SingleLineTextImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.SingleLineTextImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.SingleLineTextImpl#isRequired <em>Required</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.SingleLineTextImpl#isUnique <em>Unique</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.SingleLineTextImpl#isTranslatable <em>Translatable</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.SingleLineTextImpl#getValidationType <em>Validation Type</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.SingleLineTextImpl#getValidationRegex <em>Validation Regex</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.SingleLineTextImpl#getCustomErrorMessage <em>Custom Error Message</em>}</li>
 * </ul>
 *
 * @generated
 */
