...
public class CorefieldsPackageImpl extends EPackageImpl implements CorefieldsPackage {
	 ...
	 * @see de.enithing.fragmenthub.model.contentfragment.corefields.CorefieldsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(numberEClass, de.enithing.fragmenthub.model.contentfragment.corefields.Number.class, "Number", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNumber_Placeholder(), ecorePackage.getEString(), "placeholder", null, 1, 1, de.enithing.fragmenthub.model.contentfragment.corefields.Number.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNumber_Type(), this.getNumberTypeHint(), "type", "long", 1, 1, de.enithing.fragmenthub.model.contentfragment.corefields.Number.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNumber_DefaultValue(), ecorePackage.getEBigDecimal(), "defaultValue", "0", 1, 1, de.enithing.fragmenthub.model.contentfragment.corefields.Number.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNumber_Required(), ecorePackage.getEBoolean(), "required", "false", 1, 1, de.enithing.fragmenthub.model.contentfragment.corefields.Number.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		g1 = createEGenericType(theValidationPackage.getValidationConstraint());
		g2 = createEGenericType(ecorePackage.getEBigDecimal());
		g1.getETypeArguments().add(g2);
		initEReference(getNumber_ValidationConstraint(), g1, null, "validationConstraint", null, 0, 1, de.enithing.fragmenthub.model.contentfragment.corefields.Number.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(booleanEClass, de.enithing.fragmenthub.model.contentfragment.corefields.Boolean.class, "Boolean", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBoolean_DefaultValue(), ecorePackage.getEBoolean(), "defaultValue", "false", 1, 1, de.enithing.fragmenthub.model.contentfragment.corefields.Boolean.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoolean_Required(), ecorePackage.getEBoolean(), "required", "false", 1, 1, de.enithing.fragmenthub.model.contentfragment.corefields.Boolean.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTags_RootPath(), theFragmentHubPackage.getPathProvider(), null, "rootPath", null, 1, 1, Tags.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getContentReference_DefaultValue(), theFragmentHubPackage.getPath(), "defaultValue", null, 0, 1, ContentReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContentReference_RootPath(), theFragmentHubPackage.getPathProvider(), null, "rootPath", null, 1, 1, ContentReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getContentReferenceValue_Value(), theFragmentHubPackage.getPath(), "value", null, 1, 1, ContentReferenceValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFragmentReference_RootPath(), theFragmentHubPackage.getPathProvider(), null, "rootPath", null, 1, 1, FragmentReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
