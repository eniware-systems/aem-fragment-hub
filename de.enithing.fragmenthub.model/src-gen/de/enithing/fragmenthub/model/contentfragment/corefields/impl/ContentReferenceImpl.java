 ...
 * </p>
 * <ul>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.ContentReferenceImpl#isAllowMultiple <em>Allow Multiple</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.ContentReferenceImpl#getMaxItems <em>Max Items</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.ContentReferenceImpl#getPlaceholder <em>Placeholder</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.ContentReferenceImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.ContentReferenceImpl#getRootPath <em>Root Path</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.ContentReferenceImpl#isRequired <em>Required</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.ContentReferenceImpl#getAllowedContentTypes <em>Allowed Content Types</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.ContentReferenceImpl#isShowThumbnail <em>Show Thumbnail</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.ContentReferenceImpl#getFileSizeValidationConstraint <em>File Size Validation Constraint</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.ContentReferenceImpl#getImageWidthConstraint <em>Image Width Constraint</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.ContentReferenceImpl#getImageHeightConstraint <em>Image Height Constraint</em>}</li>
 * </ul>
 *
 * @generated
 */
