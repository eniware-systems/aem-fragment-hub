 ...
 * </p>
 * <ul>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.NumberImpl#isAllowMultiple <em>Allow Multiple</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.NumberImpl#getMaxItems <em>Max Items</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.NumberImpl#getPlaceholder <em>Placeholder</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.NumberImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.NumberImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.NumberImpl#isRequired <em>Required</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.corefields.impl.NumberImpl#getValidationConstraint <em>Validation Constraint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NumberImpl extends ContentFragmentFieldTypeImpl<NumberValue> implements de.enithing.fragmenthub.model.contentfragment.corefields.Number {
	/**
