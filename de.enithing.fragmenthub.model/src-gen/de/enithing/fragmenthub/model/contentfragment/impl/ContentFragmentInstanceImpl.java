...
import de.enithing.fragmenthub.model.contentfragment.util.ContentFragmentInstanceUtils;
 ...
 * </p>
 * <ul>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.impl.ContentFragmentInstanceImpl#getId <em>Id</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.impl.ContentFragmentInstanceImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.impl.ContentFragmentInstanceImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.impl.ContentFragmentInstanceImpl#getModel <em>Model</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.impl.ContentFragmentInstanceImpl#getFields <em>Fields</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.contentfragment.impl.ContentFragmentInstanceImpl#getContext <em>Context</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContentFragmentInstanceImpl extends MinimalEObjectImpl.Container implements ContentFragmentInstance {
	...
	public void setContext(Context newContext) {
		if (newContext != eInternalContainer() || (eContainerFeatureID() != ContentFragmentPackage.CONTENT_FRAGMENT_INSTANCE__CONTEXT && newContext != null)) {
			...
			if (newContext != null)
				msgs = ((InternalEObject)newContext).eInverseAdd(this, FragmentHubPackage.CONTEXT__CONTENT_FRAGMENTS, Context.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ContentFragmentPackage.CONTENT_FRAGMENT_INSTANCE__CONTEXT:
				return eInternalContainer().eInverseRemove(this, FragmentHubPackage.CONTEXT__CONTENT_FRAGMENTS, Context.class, msgs);
		}
