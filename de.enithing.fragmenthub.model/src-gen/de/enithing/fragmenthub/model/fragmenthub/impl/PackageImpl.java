 ...
 * </p>
 * <ul>
 *   <li>{@link de.enithing.fragmenthub.model.fragmenthub.impl.PackageImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.fragmenthub.impl.PackageImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.fragmenthub.impl.PackageImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.fragmenthub.impl.PackageImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.fragmenthub.impl.PackageImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.fragmenthub.impl.PackageImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.fragmenthub.impl.PackageImpl#getContentFragmentModelSets <em>Content Fragment Model Sets</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.fragmenthub.impl.PackageImpl#getContentRoot <em>Content Root</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.fragmenthub.impl.PackageImpl#getContentFragmentModelPath <em>Content Fragment Model Path</em>}</li>
 *   <li>{@link de.enithing.fragmenthub.model.fragmenthub.impl.PackageImpl#getContentPath <em>Content Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PackageImpl extends MinimalEObjectImpl.Container implements de.enithing.fragmenthub.model.fragmenthub.Package {
	/**
