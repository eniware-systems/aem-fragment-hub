 ...
 * </p>
 * <ul>
 *   <li>{@link de.enithing.contenthub.model.contentfragment.impl.ContentFragmentModelSetImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.enithing.contenthub.model.contentfragment.impl.ContentFragmentModelSetImpl#getModels <em>Models</em>}</li>
 *   <li>{@link de.enithing.contenthub.model.contentfragment.impl.ContentFragmentModelSetImpl#getPackage <em>Package</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContentFragmentModelSetImpl extends MinimalEObjectImpl.Container implements ContentFragmentModelSet {
	...
	public de.enithing.contenthub.model.contenthub.Package getPackage() {
		...
		return (de.enithing.contenthub.model.contenthub.Package)eInternalContainer();
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPackage(de.enithing.contenthub.model.contenthub.Package newPackage, NotificationChain msgs) {
	 ...
	 */
	@Override
	public void setPackage(de.enithing.contenthub.model.contenthub.Package newPackage) {
		if (newPackage != eInternalContainer() || (eContainerFeatureID() != ContentFragmentPackage.CONTENT_FRAGMENT_MODEL_SET__PACKAGE && newPackage != null)) {
			...
			if (newPackage != null)
				msgs = ((InternalEObject)newPackage).eInverseAdd(this, ContentHubPackage.PACKAGE__CONTENT_FRAGMENT_MODEL_SETS, de.enithing.contenthub.model.contenthub.Package.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ContentFragmentPackage.CONTENT_FRAGMENT_MODEL_SET__PACKAGE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetPackage((de.enithing.contenthub.model.contenthub.Package)otherEnd, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ContentFragmentPackage.CONTENT_FRAGMENT_MODEL_SET__PACKAGE:
				return eInternalContainer().eInverseRemove(this, ContentHubPackage.PACKAGE__CONTENT_FRAGMENT_MODEL_SETS, de.enithing.contenthub.model.contenthub.Package.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ContentFragmentPackage.CONTENT_FRAGMENT_MODEL_SET__MODELS:
				...
				return;
			case ContentFragmentPackage.CONTENT_FRAGMENT_MODEL_SET__PACKAGE:
				setPackage((de.enithing.contenthub.model.contenthub.Package)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ContentFragmentPackage.CONTENT_FRAGMENT_MODEL_SET__MODELS:
				...
				return;
			case ContentFragmentPackage.CONTENT_FRAGMENT_MODEL_SET__PACKAGE:
				setPackage((de.enithing.contenthub.model.contenthub.Package)null);
				return;
		}
