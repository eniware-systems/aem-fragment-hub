 ...
 * </p>
 * <ul>
 *   <li>{@link de.enithing.contenthub.model.contentfragment.corefields.SingleLineText#getPlaceholder <em>Placeholder</em>}</li>
 ...
 *   <li>{@link de.enithing.contenthub.model.contentfragment.corefields.SingleLineText#getValidationType <em>Validation Type</em>}</li>
 *   <li>{@link de.enithing.contenthub.model.contentfragment.corefields.SingleLineText#getValidationRegex <em>Validation Regex</em>}</li>
 *   <li>{@link de.enithing.contenthub.model.contentfragment.corefields.SingleLineText#getCustomErrorMessage <em>Custom Error Message</em>}</li>
 * </ul>
 *
...
public interface SingleLineText extends MultiFieldType<StringValue> {
	 ...
	 * @see de.enithing.contenthub.model.contentfragment.corefields.CorefieldsPackage#getSingleLineText_Placeholder()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.enithing.contenthub.model.contentfragment.corefields.SingleLineText#getPlaceholder <em>Placeholder</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link de.enithing.contenthub.model.contentfragment.corefields.TextValidationType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.enithing.contenthub.model.contentfragment.corefields.CorefieldsPackage#getSingleLineText_ValidationType()
	...
	/**
	 * Sets the value of the '{@link de.enithing.contenthub.model.contentfragment.corefields.SingleLineText#getValidationType <em>Validation Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.enithing.contenthub.model.contentfragment.corefields.CorefieldsPackage#getSingleLineText_ValidationRegex()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.enithing.contenthub.model.contentfragment.corefields.SingleLineText#getValidationRegex <em>Validation Regex</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.enithing.contenthub.model.contentfragment.corefields.CorefieldsPackage#getSingleLineText_CustomErrorMessage()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.enithing.contenthub.model.contentfragment.corefields.SingleLineText#getCustomErrorMessage <em>Custom Error Message</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
