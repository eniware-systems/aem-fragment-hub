 ...
 * </p>
 * <ul>
 *   <li>{@link de.enithing.contenthub.model.contenthub.contentfragment.corefields.impl.TabImpl#getFields <em>Fields</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TabImpl extends ContentFragmentFieldTypeImpl<ContentFragmentFieldValue> implements Tab {
	/**
	 ...
	 * @ordered
	 */
	protected EList<SimpleFieldType> fields;
	...
	protected EClass eStaticClass() {
		return CorefieldsPackage.Literals.TAB;
	}
	 ...
	 * @generated
	 */
	public EList<SimpleFieldType> getFields() {
		if (fields == null) {
			fields = new EObjectContainmentEList<SimpleFieldType>(SimpleFieldType.class, this, CorefieldsPackage.TAB__FIELDS);
		}
		return fields;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case CorefieldsPackage.TAB__FIELDS:
				getFields().clear();
				getFields().addAll((Collection<? extends SimpleFieldType>)newValue);
				return;
		}
